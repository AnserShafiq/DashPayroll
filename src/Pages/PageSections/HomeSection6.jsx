...
const HomeSection6 = () => {
  ...
  return (
    <div id='contact-section' className='flex flex-col lg:flex-row w-full mt-[2%] lg:mt-[3%]'>
        <div className='w-full lg:w-[50%] lg:pl-4 lg:py-3 min-h-[50vh] lg:min-h-[75vh]'>
            <img className='h-[50vh] lg:h-[100%] rounded-[30px] w-[100%] object-cover' src={Sidebanner} alt='Contact Section Home'/>
        </div>
